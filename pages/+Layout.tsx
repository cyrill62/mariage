...
const Menu = () => {
  ...
  <div className="navbar-center">
    <div className="megamenu max-sm:megamenu-vertical p-2 border border-base-300 megamenu-full" id="my-megamenu-1" popover>
        ...
        <a className="btn btn-light" href="#">Rechercher</a>
      </div>
  </div>
